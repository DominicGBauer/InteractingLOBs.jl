...
L = 100     # real system width (e.g. 200 meters)
...
p1_x = plot(dt, average_epps_mean, legend = false,dpi=300, ribbon=(q .* std(average_epps_value, dims = 2) * 0.001), fillalpha=.15, title="Δt=0.03 Δx=1/4")
