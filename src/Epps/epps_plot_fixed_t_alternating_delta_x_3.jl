...
# # uncomment to rerun
# epps_3 = Empirical(epps_data)
# save("Computed Data/EppsCorrection/Empirical_delta_x_3_over_4.png.jld", "epps", epps_3)

# ComputedResults = load("Computed Data/EppsCorrection/Empirical_delta_x_3_over_4.png.jld")
# epps_3 = ComputedResults["epps"]
...
p3_x = plot(dt, average_epps_mean, legend = false,dpi=300, ribbon=(q .* std(average_epps_value, dims = 2) * 0.001), fillalpha=.15, title="Δt=0.03 Δx=3/4")
xlabel!(p3_x, L"\Delta t\textrm{[sec]}")
ylabel!(p3_x, L"\rho_{\Delta t}^{ij}")
