...
myRLPusher2 = RLPushTerm(SimStartTime,SimEndTime,Position,Volume,true)
...
function quick_plot(lob_models,sim_start_time,how_many=12; center_at_midprice=true,
    ...
    savefig(p1, "Plots/PriceImpact/SingleOrderBookSurface.png")

    return Dat
end

quick_plot([lob_model¹, lob_model²],SimStartTime,8; dosum=false,plot_raw_price=true,x_axis_width=10)
